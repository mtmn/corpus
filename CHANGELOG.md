...
## [3.0.0](https://github.com/mtmn/corpus/compare/corpus-v2.8.2...corpus-v3.0.0) (2026-04-25)
...
* add about section ([f055cbd](https://github.com/mtmn/corpus/commit/f055cbd9767fe690d2351bac8a2c794e4164aac0))
* add about, labels and fix search ([346b4d5](https://github.com/mtmn/corpus/commit/346b4d5fc7425664c82be8e496dfafb4d9437cdc))
* add backups, enabled params ([cada497](https://github.com/mtmn/corpus/commit/cada497f6a566dc3bce7c714f58ec74cb52bc6a2))
* add custom user name, fixes ([0105eee](https://github.com/mtmn/corpus/commit/0105eee664727795aee703fde3095b58e3e84de0))
* add docs for submission endpoint ([81d101a](https://github.com/mtmn/corpus/commit/81d101a0dd916cdeed3664734be04a7789e0d63c))
* add filters, allow show all ([248edff](https://github.com/mtmn/corpus/commit/248edff954cb1d7e0f8d55b854b4426c9f24e560))
* add grafana dashboard ([762e5ae](https://github.com/mtmn/corpus/commit/762e5ae8062d90dd175601cb44e9f6321dda1fd8))
* add lastfm support ([f9ae9ae](https://github.com/mtmn/corpus/commit/f9ae9aee4c4815d658aabc36c8e2a0cda18c35cb))
* add listenbrainz-like endpoint ([feafab2](https://github.com/mtmn/corpus/commit/feafab2a8a43f51acf1f85573800a1a8b6d94c15))
* add logging, housekeeping ([0e601bf](https://github.com/mtmn/corpus/commit/0e601bfa065ffe4aa34b0cdab43b554ed76e63cf))
* add metrics endpoint ([429576a](https://github.com/mtmn/corpus/commit/429576a8a41a113c51c77cae83ceedba9d520520))
* add more tests, update justfile ([fa35613](https://github.com/mtmn/corpus/commit/fa356138b519c8de7e972e7c316eccde27ac60e9))
* add otel tracing ([8cd250e](https://github.com/mtmn/corpus/commit/8cd250e8f8fa3ac23b28ab960a7e30c0614a62d6))
* add search to listens section ([6b99cb9](https://github.com/mtmn/corpus/commit/6b99cb9e58cdf50b7a03a51f49a8e42b117d97af))
* add stats ([97eeb6e](https://github.com/mtmn/corpus/commit/97eeb6e2e3f7a42c8618c8f53d579d4b5e15e37a))
* add support for defining users ([92dc182](https://github.com/mtmn/corpus/commit/92dc18239440f6858d4bf26321f4573b92ebfab2))
* add tag hover ([ca89de9](https://github.com/mtmn/corpus/commit/ca89de9841db55e7805180efcbf2abd73ab9f3d5))
* add tests ([91f0021](https://github.com/mtmn/corpus/commit/91f00219a6799aad4ca110510503048856b705d3))
* add tests and update readme ([98e5070](https://github.com/mtmn/corpus/commit/98e5070357c38812b1c8c35a5cbc3efd51104994))
* add tests for endpoint ([999c811](https://github.com/mtmn/corpus/commit/999c811e963a498ef34c4b4b0840ed17a3b8db87))
* add track filter and make all filters clickable ([b57a3ce](https://github.com/mtmn/corpus/commit/b57a3ce797f4558a3bc49fee92e37c67156f6bbf))
* add user mgmt commands ([a19c9b4](https://github.com/mtmn/corpus/commit/a19c9b4436674bec22a1b55d9b83fed150072e84))
* add write locks to db ([e1cefba](https://github.com/mtmn/corpus/commit/e1cefbaee28bae5d3a22745dd10606686269c84b))
* change user slug, fixes ([35059ee](https://github.com/mtmn/corpus/commit/35059ee5306d419b0632ea23699aee9319704ac0))
* **ci:** add nix flake ([e61bcc2](https://github.com/mtmn/corpus/commit/e61bcc29c919d1596585049ef9739d57793e1c94))
* convert to avif; decouple Client.elm ([d01bb0b](https://github.com/mtmn/corpus/commit/d01bb0b28dc69f2eac9d7733fdd7002575b6e420))
* decouple large files, convert to avif, housekeeping ([4f9a89c](https://github.com/mtmn/corpus/commit/4f9a89ce5d24a41211ff9d220f73fb72b12435fa))
* deduplicate cover fetching logic ([e65c4ad](https://github.com/mtmn/corpus/commit/e65c4ad68a33cf3935bd8f8915a1c9b53826aa5d))
* deprecate .dhall users file, fmt ([9eadd11](https://github.com/mtmn/corpus/commit/9eadd119054a9e65b0ce6053fc2e386f5fdb2f9b))
* doucple Main.purs to modules ([93f2e0d](https://github.com/mtmn/corpus/commit/93f2e0d5acafce95f29d0a75420c3a99c4e3b55e))
* download large front covers from caa ([2e8d268](https://github.com/mtmn/corpus/commit/2e8d268a16effb772794cdc6bace2e5b8968b41b))
* duckdb chepoint to a bucket ([c30098b](https://github.com/mtmn/corpus/commit/c30098bccb7d0e7ba0a8b67a7577e9ca1d863058))
* duckdb, blob storage, pagination ([82b4af5](https://github.com/mtmn/corpus/commit/82b4af5fb85a7f2275c7ea631c21eafd82302c1c))
* duckdb, blob storage, pagination ([7588434](https://github.com/mtmn/corpus/commit/75884341e60299f61a76d0c6ca32a120db2c966a))
* fix builds, inline htmx to ps-halogen ([adcefbc](https://github.com/mtmn/corpus/commit/adcefbce1a2f0f7a6f3145cdac7cda9366656364))
...
* hash user token ([71c9ff7](https://github.com/mtmn/corpus/commit/71c9ff7b254bff94b0d4db7237ea0cf88b00cbc0))
* improve logging ([95c2aa3](https://github.com/mtmn/corpus/commit/95c2aa378492977c669ba62b5ea07d6e872a2387))
* integrate cosine.club api ([f6eb784](https://github.com/mtmn/corpus/commit/f6eb784a07b93f64d8a24d7df713fe08b2045593))
* lookup release json from caa before fetch ([b59bc2f](https://github.com/mtmn/corpus/commit/b59bc2ffe60e1fa8bd797209af5dd3ebcafd74f7))
* match colors to doric-obsidian ([ab11a25](https://github.com/mtmn/corpus/commit/ab11a2563dde7e877af99074e0a66debbaa6819c))
* move scrobbling logic to Sync.purs ([4f8d8de](https://github.com/mtmn/corpus/commit/4f8d8de9bf105a38012de25068364b80cb075582))
* periodic scans, disable source builds, docs ([c33abbb](https://github.com/mtmn/corpus/commit/c33abbbc38405f453456e1400a9bcb595d5dd30f))
* remove otel, add cosine.club metrics ([06522c9](https://github.com/mtmn/corpus/commit/06522c9ec707bc36a8d393f6a1bf7422818d47e2))
* rewrite into folds, cover/genre rewrite ([9463878](https://github.com/mtmn/corpus/commit/94638781984174cf89e256ee853c2c914c0deb89))
* scrobbles searchable by album ([eb06eb5](https://github.com/mtmn/corpus/commit/eb06eb543ef08c585f3117465229198a6d23ff94))
* scrobbles searchable by album ([7803007](https://github.com/mtmn/corpus/commit/7803007814b224bdac9a6cfacf2ef5f09e1a1827))
* shutdown handling, fix race conditions ([0e6c154](https://github.com/mtmn/corpus/commit/0e6c1544957a348a76cb2e81533d7d7c33e98b18))
* shutdown handling, fix race conditions ([9632dc5](https://github.com/mtmn/corpus/commit/9632dc517e3d488c3aa83c21068110a8e6f76cf6))
* simplify cover sources logic ([0a06102](https://github.com/mtmn/corpus/commit/0a06102a2d7d2f073e02b9be0945f7725f1076cb))
* **stats:** add custom date range ([abd57a1](https://github.com/mtmn/corpus/commit/abd57a1af78cd57e46a0361a3701728473b0c9da))
* **stats:** add show all expander ([a57b108](https://github.com/mtmn/corpus/commit/a57b108a149ea4784c8ed20c9474c65fa55972e6))
* try various cover art sizes ([8b8811d](https://github.com/mtmn/corpus/commit/8b8811d7e2c0cf6fe4e57880ef8d0b82470a7563))
* update user agents with github repo ([1dbde20](https://github.com/mtmn/corpus/commit/1dbde20e2804fa04fe80d9b467d10c06e14fb5b2))
* use elm in frontend instead of halogen ([6833d81](https://github.com/mtmn/corpus/commit/6833d816e33b882c8fd3fac87b8167e3bab864db))
* use elm in frontend instead of halogen ([9545793](https://github.com/mtmn/corpus/commit/9545793c8ad0f7333c5205293a4488cfa9333104))
* zoom on hover for covers, bugfixes ([c619230](https://github.com/mtmn/corpus/commit/c619230f595b49d7679f2d27636a1e4bc3383416))


### Bug Fixes

* add build step, leaky queries ([52db1af](https://github.com/mtmn/corpus/commit/52db1afe988e9d230603fe5f8bc4b28c48a089ce))
* add corsOrigin config option ([3b2e9ba](https://github.com/mtmn/corpus/commit/3b2e9bae48972f9f815fa7a4ba2dfe672833efd5))
* add label to tests ([a7f4e30](https://github.com/mtmn/corpus/commit/a7f4e30a632ad9a176b57fbfe42e603fc900dd32))
* add user management recipes, exit properly ([6c03e49](https://github.com/mtmn/corpus/commit/6c03e49dfaebd004ea832be7f65709e847a37251))
* add user-agent headers to fetchers ([e2bed95](https://github.com/mtmn/corpus/commit/e2bed95fda636e26d591fd24cf4efa267e392a80))
* cache and convert cover art in the background ([0fb8594](https://github.com/mtmn/corpus/commit/0fb859496b6ac4097930feafc8ea35858d1a72f4))
* change cover cache order to caa=&gt;discogs=&gt;lastfm ([5c9797c](https://github.com/mtmn/corpus/commit/5c9797c1be6cdfc5698174ba3af4a7552a1ece6f))
...
* count api in scrobbles metric ([010aefa](https://github.com/mtmn/corpus/commit/010aefaa2d84053d95aee09a1e93d8ca1c751f3c))
* default database path to cwd ([6cc7ece](https://github.com/mtmn/corpus/commit/6cc7ece69ae971a86ddcd29c04816801a3d25ff2))
* deprecate dhall-to-json ([b0cf508](https://github.com/mtmn/corpus/commit/b0cf508390fe81605b7c1944a14a135742c92217))
* dont block startUser on sync ([6d5a660](https://github.com/mtmn/corpus/commit/6d5a660bc17c4bb57bbf8f5289ac010514c5fe22))
* **elm:** expose only necessary html tags ([5ef660d](https://github.com/mtmn/corpus/commit/5ef660db7ed2f392b1ae0f384725b1bf6f92698a))
* **elm:** expose only necessary html tags ([acfd25b](https://github.com/mtmn/corpus/commit/acfd25b0733120db7e67f7020f2c74e80945badf))
* flaky tests, ignore results ([446af57](https://github.com/mtmn/corpus/commit/446af57b053534e856ca0438165f7c3de69339fe))
* get rid of regex interop functions ([3896037](https://github.com/mtmn/corpus/commit/3896037a5b404bb30eaa39e8fd9fa89cf5cbd717))
* gha backoff on error ([d597f95](https://github.com/mtmn/corpus/commit/d597f956596a4c1ff9cd752c688289d546d09339))
* initialSync halts syncing, broken range query ([99e8028](https://github.com/mtmn/corpus/commit/99e802804943177b0110926601096350e82903a3))
* instrument complete HTTP span ([c6f7605](https://github.com/mtmn/corpus/commit/c6f7605678876dde19878e5bcd85a2001405eb79))
* make css less whimsical, i think ([e19fa83](https://github.com/mtmn/corpus/commit/e19fa830116ed60e4c23a039d174dfbcc54d5c46))
* missing doc entries ([86314ec](https://github.com/mtmn/corpus/commit/86314ecea72cf207715fd2bf568cfd39d3c6243b))
* missing selection for track and album ([a96810e](https://github.com/mtmn/corpus/commit/a96810eb4cf9a3ee74ca0c73c987b67dc8c1ed0b))
* move template to a separate file ([aae7ecf](https://github.com/mtmn/corpus/commit/aae7ecf2c535ac4b483bda061f83962272677152))
* move user to config, click listens go home ([e07c9c8](https://github.com/mtmn/corpus/commit/e07c9c839b8d13395caa9dd4cb3b98d94a7a7159))
* open cover on click, genre tag css ([096e7ad](https://github.com/mtmn/corpus/commit/096e7ad5ffa73313e5695abc320a2eda81310ac4))
* optimize client.js output ([1bec5be](https://github.com/mtmn/corpus/commit/1bec5be07224d26f8e0c478aa33dd7ccf263846a))
* remove initialSync param ([fb55c02](https://github.com/mtmn/corpus/commit/fb55c025ef5c09d3659de40e99cf243b12c86c98))
* remove unused imports ([82bbb06](https://github.com/mtmn/corpus/commit/82bbb061aa0d3d4e001b1727268660f91134d29d))
* remove unused imports; better logging ([4d0fb8e](https://github.com/mtmn/corpus/commit/4d0fb8e77a8b5ef721a2da4e41c917d668453b46))
* revert release-please gha ([f179336](https://github.com/mtmn/corpus/commit/f179336acb1a69aa88fe4a763947b45060ab130a))
* run npmDepsHash job on each commit ([5dac304](https://github.com/mtmn/corpus/commit/5dac304dc349fcf0399bdc709f7b68ff31615d6d))
* sanitize duckdb queries ([280b211](https://github.com/mtmn/corpus/commit/280b2115ca846ac7246e33387160da68eb867c91))
* sanitize log output; remove cors ([a40739b](https://github.com/mtmn/corpus/commit/a40739b33c11b873bd87b9ef8277a5355e8649e7))
* unhandled last.fm errors ([304c446](https://github.com/mtmn/corpus/commit/304c446cb01f7d37aa004bae05030534e0a3fe15))
* unhandled last.fm json serialization ([697864f](https://github.com/mtmn/corpus/commit/697864f57afd7be5fe324529926d373c81de3704))
* update docs; add metrics switch, fixes ([8008ede](https://github.com/mtmn/corpus/commit/8008ede24ab1dde56c14ed552d91babc7a473269))
* update nix hashes ([d58489b](https://github.com/mtmn/corpus/commit/d58489b29506923144e34b634541427f8dbcc3c2))
* update tests ([651191b](https://github.com/mtmn/corpus/commit/651191b8f202b0e6670de53012782c5e1312a000))
* use native ps for url handling ([f0f178f](https://github.com/mtmn/corpus/commit/f0f178fe2a469da869cfbd28997f51491a05c2dd))
* wording in about ([31a70d3](https://github.com/mtmn/corpus/commit/31a70d3181fe5907f5bcd2872ee1f0a0184d23ee))
* yeild request when duckdb connection is present ([4c423ee](https://github.com/mtmn/corpus/commit/4c423ee4dc265ea073580c663d8c664d9d6337df))
